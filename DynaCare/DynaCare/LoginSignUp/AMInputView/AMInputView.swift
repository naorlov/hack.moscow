...
@IBDesignable class AMInputView: UIView,UITextFieldDelegate {
    ...
    func setViewExpandMode(expand:Bool) {
        ...
        backViewHeightExpandConstraint.priority = UILayoutPriority(expand ? 500 :200);
        labelViewHTopExpandConstraint.priority = UILayoutPriority(expand ? 500 :200);
        labelViewRightExpandConstraint.priority = UILayoutPriority(expand ? 500 :300);
        labelViewLeftExpandConstraint.priority = UILayoutPriority(expand ? 999:300);
